...
ダウンロードはこちら:[Google Play](https://play.google.com/store/apps/details?id=com.a3colorr.hangsupandvibrate)
...
- アプリのアップデート後に振動パターンを変えようとしたら、アプリがエラー終了または起動しなくなりました
  - 当アプリのリセット（データおよびキャッシュを消去）してを試してださい。
    1. [設定] > [アプリと通知 (またはアプリ)] > [電話を切ったら振動する] > [ストレージ]に移動する
...
"電話を切ったら振動する"(当アプリと呼びます)は3Colorr(私または作者または著作権者と呼びます)が所有しています。この利用規約では、あなたはユーザーと呼ばれます。

"電話を切ったら振動する\"を利用するには、利用規約に同意することが必要です。
...
"電話を切ったら振動する"(当アプリと呼びます)は3Colorr(私または著作権者と呼びます)が所有しています。このポリシーでは、あなたはユーザーと呼ばれます。
